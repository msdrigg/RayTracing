...
class TestPlasmaFrequencySquaredQPInAtmosphere(BasePlasmaFrequencyTestCase):
    plasma_frequency_calculations_file_name = os.path.join(
        THIS_DIR,
        "calculations/quasi_parabolic_in_atmosphere_calculations.json"
    )
...
class TestPlasmaFrequencySquaredQPAboveAtmosphere(BasePlasmaFrequencyTestCase):
    plasma_frequency_calculations_file_name = os.path.join(
        THIS_DIR,
        "calculations/quasi_parabolic_above_atmosphere_calculations.json"
    )
...
class TestPlasmaFrequencySquaredQPBelowAtmosphere(BasePlasmaFrequencyTestCase):
    plasma_frequency_calculations_file_name = os.path.join(
        THIS_DIR,
        "calculations/quasi_parabolic_below_atmosphere_calculations.json"
    )
