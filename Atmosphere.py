...
class Atmosphere(ABC):
    def visualize(self, initial_point, final_point, fig=None, ax=None,
                  point_number=100, show=False, using_spherical=False, plot_range=None):
        if using_spherical:
...
class QuasiParabolic(Atmosphere):
    ...
    def parameters(self, new_params):
        # For this model, the parameters are (f0, hm, ym)
        self._parameters = new_params
